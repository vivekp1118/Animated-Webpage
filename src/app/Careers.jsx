    ...
    return (  
        <div className="h-[90vh] w-[100%] p-20 mt-10 border-solid border-b-[3px] border-gray-300">
            ...
            <div className="w-[340px] h-[auto] bg-[#FEFBEC] p-7 rounded-2xl shadow-lg">
                    ...
                    <li className="text-sm text-gray-800 font-medium">Full-time position</li>
                    <li className="text-sm text-gray-800 font-medium">Berlin or remote</li>
                    <li className="text-sm text-gray-800 font-medium">€65-85k, 0.5-1.50% equity share options</li>
                    </div>
                </div>
                ...
                <div className="w-[340px] h-[auto] bg-[#FEFBEC] p-7 rounded-2xl shadow-lg">
                    ...
                    <li className="text-sm text-gray-800 font-medium">Full-time position</li>
                    <li className="text-sm text-gray-800 font-medium">Berlin or remote</li>
                    <li className="text-sm text-gray-800 font-medium">€40-55k, 0.25-0.50% equity share options</li>
                    </div>
                </div>
                ...
                <div className="w-[340px] h-[auto] bg-[#FEFBEC] p-7 rounded-2xl shadow-lg">
                    ...
                    <li className="text-sm text-gray-800 font-medium">Full-time position</li>
                    <li className="text-sm text-gray-800 font-medium">Berlin or remote</li>
                    <li className="text-sm text-gray-800 font-medium">€20-24k, 0.5-1.50% equity share options</li>
                    </div>
                </div>
            </div>
        </div>
